...
**Gear-Engine** consumes **Scaffold** modules as Unity Package Manager (UPM) **git dependencies** (see [`Packages/manifest.json`](Packages/manifest.json)); package sources resolve under `Library/PackageCache`. Gameplay and app code live under `Assets/GearEngine/` with assembly boundaries (`.asmdef`), documentation, and project analyzers under `Analyzers/`.
