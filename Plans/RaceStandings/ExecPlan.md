...
- [x] Commit coherent implementation/evidence groups and integrate into local main; no remote push.
...
- [x] Commit the navigation change and evidence, then integrate locally into main.
...
Follow-up evidence commit: `827e98ed`. Local integration: `main <- codex/rewards-return-home`, rechecked against `65a7ecc6`, with no conflicts. Only this completion record differs from the validated source branch. No push.
