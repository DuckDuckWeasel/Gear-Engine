...
Generated: 2026-07-27T20:09:03.165176+00:00

## Test intent

Validate UI effect action compatibility after Blackboard actions became managed definitions.

## Selection

- Project: `/Users/leonardosilva/.codex/worktrees/a62b/Gear Engine`
- Platform mode: `edit`
- Selector: `GearEngine.GearEngine.Tests.Editor.UIEffectActionsTests`

## Outcome

| Platform | Result | Total | Passed | Failed | Skipped | Inconclusive |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| EditMode | Passed | 17 | 17 | 0 | 0 | 0 |
