...
{
    /// <summary>
    /// Simple debug/test HUD for the Test2 scene. Shows speed, lap,
    /// progress, and provides 5 sliders for real-time stat tuning plus
    /// start/pause control. References <see cref="Test2Bootstrap"/> instead of
    /// the full <see cref="Bootstrap.SplineEvaluateBootstrap"/>.
    /// </summary>
    public sealed class Test2HUD : MonoBehaviour
    {
        [Header("References")]
        [SerializeField] private Test2Bootstrap bootstrap;
