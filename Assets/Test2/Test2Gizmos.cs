...
{
    /// <summary>
    /// Scene-view gizmo drawer for the Test2 scene.
    ...
    /// References <see cref="Test2Bootstrap"/> instead of
    /// <see cref="Bootstrap.SplineEvaluateBootstrap"/>.
    /// Works in both Edit and Play mode.
    /// </summary>
    [ExecuteAlways]
    public sealed class Test2Gizmos : MonoBehaviour
    {
        [Header("References")]
