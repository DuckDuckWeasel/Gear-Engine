...
namespace Game.GearEngine
{
    public abstract class NodeBase : IGridNode
    {
        ...
        {
            // Smoothly snap to closest 90-degree orthogonal rest state while winding down.
            float nearest90 = Mathf.Round(CurrentRotation / 90f) * 90f;
            CurrentRotation = Mathf.LerpAngle(CurrentRotation, nearest90, deltaTime * 5f);
