...
namespace Fungus.EditorUtils
{
    ...
    public class SayEditor : CommandEditor
    {
        ...
        protected SerializedProperty waitForCompleteProp;
        ...
        public override void OnEnable()
        {
            ...
            waitForCompleteProp = serializedObject.FindProperty("waitForComplete");
        ...
        public override void DrawCommandGUI() 
        {
            ...
            EditorGUILayout.PropertyField(waitForCompleteProp);
