...
{
    [Serializable]
    public sealed class GameStartedTriggerDefinition : TriggerDefinition
    {
        ...
        private sealed class Binding : TriggerBindingBase
        {
            ...
            {
                subscription = Context.EventBus.Subscribe<BlackboardStartedEvent>(OnBlackboardStarted);
            }
            ...
            private void OnBlackboardStarted(BlackboardStartedEvent eventValue)
            {
