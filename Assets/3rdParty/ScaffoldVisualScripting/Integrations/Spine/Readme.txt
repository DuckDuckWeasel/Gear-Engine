This package contains Scaffold Commands to support Spine by Esoteric Software
...
3. Open the Scaffold-Spine/Scenes/Dr Jeckle scene for an example of how to use the Spine commands
