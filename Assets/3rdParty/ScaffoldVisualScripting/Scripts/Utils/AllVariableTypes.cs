...
{
    /// <summary>
    /// Static cache of all scaffold variable types, used by commands that are designed to work on
    /// any and all variable types supported by Scaffold.
    ///
    ...
    /// <summary>
    /// Collection of every Scaffold VariableData type, used in commands that are designed to
