...
{
    /// <summary>
    /// A simple struct wrapping a reference to a Scaffold Variable. Allows for VariableReferenceDrawer. 
    /// This is the a way to directly reference a scaffold variable in external c# scripts, it will 
    /// give you an inspector field that gives a drop down of all the variables on the targeted
    /// blackboard, in a similar way to what you would expect from selecting a variable on a command.
    /// 
