...
{
    /// <summary>
    /// Helper script that auto generates the required script for ScaffoldVariables that wrap existing classes.
    ///
    /// Intended to speed up the creation of scaffold wrappers of unity builtin types and custom user types.
    /// </summary>
    public class VariableScriptGenerator
    {
        ...
        //data and helper for a single native to single scaffold type
        public class ScaffoldVariableTypeHelper
        {
            ...
            {
                public TypeHandler(Type native, Type scaffoldType, string localName, string nativeAsString = null, string scaffoldTypeAsString = null)
                {
                    NativeType = native;
                    NativeTypeString = string.IsNullOrEmpty(nativeAsString) ? native.Name : nativeAsString;
                    ScaffoldType = scaffoldType;
                    ScaffoldTypeString = string.IsNullOrEmpty(scaffoldTypeAsString) ? scaffoldType.Name : scaffoldTypeAsString;
                    LocalVariableName = localName;
                }

                public Type NativeType { get; set; }
                public Type ScaffoldType { get; set; }
                public string NativeTypeString { get; set; }
                public string ScaffoldTypeString { get; set; }
                public string LocalVariableName { get; set; }

                public string GetLocalVariableNameWithDeclaration()
                {
                    return "var " + LocalVariableName + " = inOutVar as " + ScaffoldTypeString + ';';
                }

                public string GetVarPropText()
                {
                    return "typeof(" + ScaffoldTypeString + ")";
                }
            }
        ...
        private ScaffoldVariableTypeHelper helper = new ScaffoldVariableTypeHelper();
        ...
        private const string ScriptLocation = "./Assets/Scaffold/Scripts/";
        ...
        private const string EditorDataDrawerScriptTemplate = @"/*This script has been, partially or completely, generated by the Scaffold.GenerateVariableWindow*/
using UnityEditor;
using UnityEngine;
...
{{
    ...
    {{ }}
        ...
        private const string VariableAndDataScriptTemplate = @"/*This script has been, partially or completely, generated by the Scaffold.GenerateVariableWindow*/
using UnityEngine;
{1}
...
{{
	...
	{{
        ...
        private const string VariableOnlyScriptTemplate = @"/*This script has been, partially or completely, generated by the Scaffold.GenerateVariableWindow*/
using UnityEngine;
{1}
...
{{
	...
	{{ }}
        ...
        private const string DataBasedPropertyScriptTemplate = @"/*This script has been, partially or completely, generated by the Scaffold.GenerateVariableWindow*/
using UnityEngine;
...
{5}
        ...
        private const string VariableOnlyPropertyScriptTemplate = @"/*This script has been, partially or completely, generated by the Scaffold.GenerateVariableWindow*/
using UnityEngine;
...
{5}
        ...
        {
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Animator), typeof(AnimatorVariable), "ioani"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(AudioSource), typeof(AudioSourceVariable), "ioaud"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(bool), typeof(BooleanVariable), "iob"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Collider2D), typeof(Collider2DVariable), "ioc2d"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Collider), typeof(ColliderVariable), "ioc"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Collection), typeof(CollectionVariable), "iocollect"));
            //we don't need to do collision varaibles
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Color), typeof(ColorVariable), "iocol"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(float), typeof(FloatVariable), "iof"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(GameObject), typeof(GameObjectVariable), "iogo"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(int), typeof(IntegerVariable), "ioi"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Material), typeof(MaterialVariable), "iomat"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Matrix4x4), typeof(Matrix4x4Variable), "iom4"));
            //we skip object
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Quaternion), typeof(QuaternionVariable), "ioq"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Rigidbody2D), typeof(Rigidbody2DVariable), "iorb2d"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Rigidbody), typeof(RigidbodyVariable), "iorb"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Sprite), typeof(SpriteVariable), "iospr"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(string), typeof(StringVariable), "ios"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Texture), typeof(TextureVariable), "iotex"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Transform), typeof(TransformVariable), "iot"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Vector2), typeof(Vector2Variable), "iov2"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Vector3), typeof(Vector3Variable), "iov"));
            helper.AddHandler(new ScaffoldVariableTypeHelper.TypeHandler(typeof(Vector4), typeof(Vector4Variable), "iov4"));
