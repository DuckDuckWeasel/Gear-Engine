...
namespace Scaffold
{
    ...
    public class SaveManager : MonoBehaviour
    {
        ...
        protected virtual void ExecuteBlocks(string savePointKey)
        {
            ...
            // TODO: (Scaffold Migration) SavePoints are now IActions. FindObjectsOfType will not find them.
            // This logic must be rewritten to scan blocks for InvokeActionCommands containing SavePointActions.
        }
