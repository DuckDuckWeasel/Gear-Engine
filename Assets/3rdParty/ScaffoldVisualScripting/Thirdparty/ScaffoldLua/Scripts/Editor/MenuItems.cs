...
namespace Scaffold
{
    ...
    {
        [MenuItem("Tools/Scaffold/Create/Lua", false, 2000)]
        static void CreateLua()
        {
            SpawnPrefab("Prefabs/Lua", false);
        }

        [MenuItem("Tools/Scaffold/Create/Lua File", false, 2001)]
        ...
        [MenuItem("Tools/Scaffold/Create/Lua Environment", false, 2100)]
        static void CreateLuaEnvironment()
        {
            SpawnPrefab("Prefabs/LuaEnvironment", false);
        }

        [MenuItem("Tools/Scaffold/Create/Lua Bindings", false, 2101)]
        static void CreateLuaBindings()
        {
            SpawnPrefab("Prefabs/LuaBindings", false);
        }

        [MenuItem("Tools/Scaffold/Create/Lua Script", false, 2102)]
        static void CreateLuaScript()
        {
            SpawnPrefab("Prefabs/LuaScript", false);
        }

        [MenuItem("Tools/Scaffold/Create/Lua Store", false, 2103)]
        ...
        /// </summary>
        [MenuItem("Tools/Scaffold/Utilities/Info Text")]
