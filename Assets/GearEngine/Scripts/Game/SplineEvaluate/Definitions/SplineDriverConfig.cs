...
namespace GearEngine.SplineEvaluate.Definitions
{
    ...
    /// <para>
    /// This replaces <see cref="GearEngine.CarSimulation.Definitions.SplineCarRunnerConfigSO"/>
    /// for the physics-free simulation branch. There is no dependency on
    /// PrometeoCarController or Rigidbody.
    /// </para>
    /// </summary>
    [CreateAssetMenu(menuName = "GearEngine/Spline Evaluate/Driver Config", fileName = "SplineDriverConfig")]
    public sealed class SplineDriverConfig : ScriptableObject
    {
        // ── Speed ──────────────────────────────────────────────────────
