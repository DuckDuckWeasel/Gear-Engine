...
namespace GearEngine.GearEngine.Editor
{
    ...
    {
        public const string StubPrefabPath = "Assets/GearEngine/Gears/GearEngineView_NavigationStub.prefab";
        public const string ViewConfigPath = "Assets/GearEngine/Data/Gear/GearEngineViewConfig.asset";
        public const string NavigationSettingsPath = "Assets/Navigation/Navigation Settings.asset";
