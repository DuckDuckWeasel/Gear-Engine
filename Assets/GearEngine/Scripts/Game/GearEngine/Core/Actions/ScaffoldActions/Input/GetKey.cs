...
{
    // <summary>
    /// Store UnityEngine.Input.GetKey in a variable. Supports an optional Negative key input. A negative value will be overridden by a positive one, they do not add.
    /// </summary>
    [CommandInfo("Input",
                 "GetKey",
                 "Store UnityEngine.Input.GetKey in a variable. Supports an optional Negative key input. A negative value will be overridden by a positive one, they do not add.")]
    ...
    public class GetKey : ActionBase
    {
        ...
        [Tooltip("Do we want an UnityEngine.Input.GetKeyDown, GetKeyUp or GetKey")]
        [SerializeField]
