...
namespace Scaffold
{
    ...
    [CommandInfo("Sprite", 
                 ...
                 "Sets the Renderer sorting layer of every child of a game object. Applies to all Renderers (including mesh, skinned mesh, and sprite).")]
    [Serializable]
    public class SetSortingLayer : ActionBase 
    {
        ...
        {
            var renderer = target.gameObject.gameObject.gameObject.GetComponent<Renderer>();
            if (renderer)
            {
        ...
        public override void OnEnter()
        {
            ...
            {
                ApplySortingLayer(targetObject.gameObject.transform, sortingLayer);
            }
